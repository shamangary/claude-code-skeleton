...
**Role:** **Automated pull-request review** that orchestrates **multiple subagents** (Haiku gates, Sonnet reviewers, Opus bug finders), **validates** suspected issues to cut false positives, and optionally posts **inline GitHub comments** via MCP.
...
**Neighbors:** [`.claude-plugin/MACRO.md`](.claude-plugin/MACRO.md); [`commands/code-review.macro.md`](commands/code-review.macro.md).
